...
climate$methods(plot_yearly_comparison = function(data_list=list(), variables = "Total Rain", col = c("blue", "red", "green"), type = c("h", "h", "h"), lty= c(1,2,3), lty_points= c(1,2,3), ylabel, xlabel = "Year",lwd=c(2), 
